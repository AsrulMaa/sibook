                        ...
                        <tr>
                            ...
                            <td>
                               <!-- <div class="text-center"><a href="<?= base_url("admin/users/edit/$r->id") ?>" class="btn btn-sm btn-warning edit" title="Edit" id="edit" data-id = "<?= $r->id ?> "><i class="fa fa-pencil"></i>Edit </a>
                                ...
                                <button type="button" class="btn btn-sm btn-danger delete" title="Delete" id="delete" data-id = "<?= $r->id ?>" data-href="<?= site_url('admin/users/deleteData/' . $r->id); ?>"><i class="fa fa-trash"></i>Delete</button></div> -->

                                <a class="btn btn-sm btn-primary tambah" href="<?= base_url('admin/users/change/alpa/'.$r->id); ?>" ><i class="fa fa-trash"></i>ALPA</a></div>

                                <a class="btn btn-sm btn-primary tambah" href="<?= base_url('admin/users/change/izin/'.$r->id); ?>" ><i class="fa fa-trash"></i>Izin</a></div>

                                <a class="btn btn-sm btn-primary tambah" href="<?= base_url('admin/users/change/sakit/'.$r->id); ?>" ><i class="fa fa-trash"></i>Sakit</a></div>
                            </td>
                        </tr>
                    <?php endforeach ?>
                    <?php if ($total_rows == 0) :?>
...
jQuery(document).ready(function() {
   ...
   //for delete
    $(document).on('click', '#delete', function(){
       ...
       var url = '<?= base_url()?>admin/users/index';
        swal({
                title: "Anda Yakin?",
