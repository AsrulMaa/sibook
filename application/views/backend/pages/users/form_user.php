                 ...
                 <?= form_open('', [
                  ...
                  <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="fullname" id="fullname" placeholder="First Name" value="">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          <?= form_dropdown('role', getDropdownList('role', ['id', 'role']), '', ['class' => 'form-control select2']); ?>
                            <small class="info help-block">
                             Select one role.
                          </small>
                        </div>
