               ...
               <div class="box box-widget widget-user-2">
                 ...
                 <?= form_open('', [
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="<?= set_value('username', $input->username) ?>">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="fullname" id="fullname" placeholder="First Name" value="<?= set_value('fullname', $input->fullname) ?>">
                          <small class="info help-block"></small>
                        </div>
                    </div>

                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Role <i class="required">*</i></label>

                        <div class="col-sm-8">
                          <?= form_dropdown('role', getDropdownList('role', ['id', 'role']), set_value('fullname', $input->id_role) , ['class' => 'form-control select2']); ?>
                            <small class="info help-block">
                             Select one role.
                          </small>
                        </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <div id="user_avatar_galery" src="<?= BASE_URL . 'uploads/user/' . $input->avatar; ?>" ></div>
                    ...
                    <div class="row-fluid col-md-7">
                        <a class="btn btn-flat btn-info btn_save btn_action btn_save_back" id="btn_save" data-stype='back' title="save and back to the list (Ctrl+d)"><i class="ion ion-ios-list-outline" ></i> Update </a>
...
<script>
  $(document).ready(function() {
    ...
    $('.btn_save').click(function() {
        ...
        $.ajax({
                url: BASE_URL + 'admin/users/edit_save/1',
                type: 'POST',
                dataType: 'json',
                data: data_post,
            })
    ...
    $('#user_avatar_galery').fineUploader({
        ...
        thumbnails: {
         ...
         session: {
           endpoint: BASE_URL + 'admin/users/get_avatar_file/<?= $input->id; ?>',
